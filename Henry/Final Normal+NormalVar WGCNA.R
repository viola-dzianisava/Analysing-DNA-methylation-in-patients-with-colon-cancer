...
top_methylation_data_normal <- methylation_values_clean_normal[top_genes_normal, ]
...
datMethyl_clean_normal <- t(as.matrix(top_methylation_data_normal))
...
save_path_normal <- "C:/Users/Henry/Desktop/Dissertation/WGCNA_results_normal.RData"
...
for (module in unique_modules_normal) {
  ...
  heatmap_file <- paste0("C:/Users/Henry/Desktop/Dissertation/FinalFindings/NN/heatmap_normal_", module, ".png")
...
heatmap_tom_file <- "C:/Users/Henry/Desktop/Dissertation/FinalFindings/NN/WGCNA_heatmap_normal.png"
heatmap_clusters_file <- "C:/Users/Henry/Desktop/Dissertation/FinalFindings/NN/WGCNA_clusters_heatmap_normal.png"
